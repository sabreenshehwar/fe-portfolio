...
export default function Contact() {
    ...
    function sendEmail(e) {
        ...
        emailjs.sendForm('gmail', 'template_p8p4bni', e.target, 'wrhgXVepnLrhTGrh4')
            .then((result) => {
    ...
    return (
        ...
        <div className="contact__container" id='contact'>
            <header>
                <p className="contact__p">Ready to take your business to the next level? </p>
                <h1>Get in touch with me
                    <br /> <br />
                    <AiOutlineArrowDown />
                </h1>
                <a href="https://www.instagram.com/ssabvy/">
                ...
                <a href="https://www.linkedin.com/in/sabreen-shehwar-b3090b259/">
